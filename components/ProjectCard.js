export default function ProjectCard({ title, desc, tech, link, image }) {
  return (
    <div className="bg-gray-900 border border-green-500 rounded-lg p-6 transform transition-transform hover:scale-105 hover:shadow-lg hover:shadow-green-500/50">
      <img
        ...
        className="w-full h-32 object-cover rounded-t-lg mb-4 transition-transform hover:scale-110"
      />
